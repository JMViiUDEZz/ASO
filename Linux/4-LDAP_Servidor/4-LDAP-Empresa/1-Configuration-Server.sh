...
############-----Estructura-----###################
###################################################
echo dn: ou=usuarios,dc=asir,dc=local > /home/ldapPlantilla.ldif
...
echo dn: ou=grupos,dc=asir,dc=local >> /home/ldapPlantilla.ldif
echo objectclass: organizationalUnit >> /home/ldapPlantilla.ldif
echo ou: grupos >> /home/ldapPlantilla.ldif

echo '' >> /home/ldapPlantilla.ldif

echo dn: cn=directores,ou=grupos,dc=asir,dc=local >> /home/ldapPlantilla.ldif
...
echo '' >> /home/ldapPlantilla.ldif
echo dn: cn=administracion,ou=grupos,dc=asir,dc=local >> /home/ldapPlantilla.ldif
echo objectclass: posixGroup >> /home/ldapPlantilla.ldif
...
echo dn: cn=tecnologia,ou=grupos,dc=asir,dc=local >> /home/ldapPlantilla.ldif
echo objectclass: posixGroup >> /home/ldapPlantilla.ldif
...
echo dn: cn=ventas,ou=grupos,dc=asir,dc=local >> /home/ldapPlantilla.ldif
echo objectclass: posixGroup >> /home/ldapPlantilla.ldif
...
echo dn: cn=recursosHumanos,ou=grupos,dc=asir,dc=local >> /home/ldapPlantilla.ldif
echo objectclass: posixGroup >> /home/ldapPlantilla.ldif
...
echo dn: cn=marketing,ou=grupos,dc=asir,dc=local >> /home/ldapPlantilla.ldif
echo objectclass: posixGroup >> /home/ldapPlantilla.ldif
...
ldapadd -x -W -D 'cn=admin,dc=asir,dc=local' -f /home/ldapPlantilla.ldif 